        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-4xl font-bold text-white mb-3 drop-shadow-lg">
              Latest <span className="text-white/90">Insights</span>
            </h2>
