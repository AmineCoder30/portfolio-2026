...
gsap.to(
  ".right-tech-icon",
      {
        ...
        y: 200,
      x: -200,
      willChange: "filter, transform, opacity", ease: "power3.out",
      scrollTrigger: {
        trigger: containerRef.current,
        start: "top top",
        end: "bottom top",
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen flex items-center justify-center overflow-hidden py-20 px-4 sm:px-6">
      {/* Animated Background */}
      ...
      <div className="relative  z-10 max-w-[90rem] w-full text-center mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto px-6">
          <CustomButton size="lg" className="w-full sm:w-auto h-12 px-8 text-base">
            View Work
            <span className="ml-2">→</span>
          </CustomButton>
          <CustomButton variant="outline" size="lg" className="w-full sm:w-auto h-12 px-8 text-base">
            Contact Me
          </CustomButton>
        </div>
      </div>
