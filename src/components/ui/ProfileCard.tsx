...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, var(--color-bg-surface) 0%, var(--color-primary) 100%)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'var(--color-primary)',
      ...
      '--sunpillar-1': 'var(--color-primary)',
      '--sunpillar-2': 'var(--color-secondary)',
      '--sunpillar-3': 'var(--color-primary)',
      '--sunpillar-4': 'var(--color-secondary)',
      '--sunpillar-5': 'var(--color-primary)',
      '--sunpillar-6': 'var(--color-secondary)',
  ...
  const shineStyle = {
    ...
    backgroundImage: `
      ...
      repeating-linear-gradient(
        ...
        var(--color-secondary) 3.8%,
        var(--color-primary) 4.5%,
        var(--color-secondary) 5.2%,
        var(--color-bg-surface) 10%,
        var(--color-bg-surface) 12%
      ),
      radial-gradient(
